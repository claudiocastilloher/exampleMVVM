package com.claudiocastillo.examplemvvm.model

//Paso 2 creamos el priveder para proporcionar los datos locales
class QuoteProvider {
    //Creamos un comanion objet para poder acceder a la lista desde donde sea
    companion object {
